  ...
  return (
    <div className="bg-white border rounded-lg">
      ...
      <AddWorkItemDialog
        ...
        onAdd={(newItem: any) => {
          // Make sure amount exists for display; if API doesn’t return it, derive it
          const amount =
            typeof newItem.amount === "number" ? newItem.amount : (newItem.quantity ?? 0) * (newItem.rate ?? 0)

          onAdd({ ...newItem, amount })
        }}
